...
#Se define que un producto hay que solicitarlo al proveedor si sus unidades en stock son menores al Nivel de Reorden. ¿Hay productos por solicitar? Se quiere conocer todos los productos del listado anterior, pero que unidades pedidas sea igual a cero.
...
SELECT * FROM facturadetalle WHERE Cantidad >= 50 AND Cantidad <= 100;
...
SELECT FacturaID,ProductoID,Cantidad*PrecioUnitario  AS Total  FROM facturadetalle;
